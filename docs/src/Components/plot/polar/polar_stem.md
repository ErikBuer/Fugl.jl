        ...
        PolarPlot(
            [
                PolarStem(
                    Float32.(r),
                    Float32.(theta),
                    stem_color=Vec4f(0.4, 0.6, 0.9, 1.0),
                    stem_width=2.0f0,
                    marker_fill_color=Vec4f(0.4, 0.6, 0.9, 1.0),
        ...
        PolarPlot(
            [
                PolarStem(
                    Float32.(r1),
                    Float32.(theta),
                    stem_color=Vec4f(0.9, 0.4, 0.4, 1.0),  # Red
                    stem_width=2.0f0,
                ...
                PolarStem(
                    Float32.(r2),
                    Float32.(theta),
                    stem_color=Vec4f(0.4, 0.9, 0.4, 1.0),  # Green
                    stem_width=2.0f0,
                    marker_fill_color=Vec4f(0.4, 0.9, 0.4, 1.0),
                    marker_border_color=Vec4f(0.9, 0.9, 0.95, 1.0),
                    marker_size=9.0f0,
                    marker_border_width=1.5f0
                )

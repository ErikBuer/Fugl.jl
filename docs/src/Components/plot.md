...
function MyApp()
    ...
    IntrinsicColumn([
        ...
        IntrinsicHeight(Container(Text("Current Y bounds: $(round(something(plot_state[].current_y_min, plot_style.initial_y_min), digits=2)) to $(round(something(plot_state[].current_y_max, plot_style.initial_y_max), digits=2))"))),
    ], padding=0.0, spacing=0.0)
end

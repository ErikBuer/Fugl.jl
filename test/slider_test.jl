                        ...
                        Column([
                            HorizontalSlider(
                                ...
                                on_state_change=(new_state) -> begin
                                    ...
                                    println("Basic slider: value=$(new_state.value), focused=$(new_state.is_focused)")
                                end,
                                on_change=(new_value) -> println("Basic value: ", new_value)
                            ),
                            Fugl.Text("Value: $(round(basic_slider_state[].value, digits=3)) | Focused: $(basic_slider_state[].is_focused)", style=dark_text_style)
                        ]),
                        ...
                        Column([
                            HorizontalSlider(
                                ...
                                on_state_change=(new_state) -> begin
                                    ...
                                    println("Continuous state: value=$(new_state.value), focused=$(new_state.is_focused), dragging=$(new_state.is_dragging)")
                                end,
                                on_change=(new_value) -> println("Continuous value: ", new_value)
                            ),
                            Fugl.Text("Value: $(round(continuous_state[].value, digits=3)) | Focused: $(continuous_state[].is_focused) | Dragging: $(continuous_state[].is_dragging)", style=dark_text_style)
                        ]),
                        style=dark_card_style,
                        title_style=dark_card_title_style
                    ),

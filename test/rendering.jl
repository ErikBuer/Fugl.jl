...
@testitem "Generate Container" begin
    ...
    Glance.screenshot(MyApp, "test_output/ui_screenshot.png", 400, 300)
end
...
@testitem "Test Text" begin
    ...
    # Save a screenshot of the UI
    Glance.screenshot(MyApp, "test_output/text_screenshot.png", 400, 300)
end


@testitem "Test orthographic Projection Matrix" begin
    projection_matrix = Glance.get_orthographic_matrix(0.0, 1920.0, 1080.0, 0.0, -1.0, 1.0)

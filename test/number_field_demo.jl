        ...
        IntrinsicColumn([
                ...
                Container(
                    NumberField(
                        ...
                        on_focus_change=(new_state) -> float_field_state[] = new_state
                    )
                ),
                ...
                Container(
                    NumberField(
                        ...
                        on_focus_change=(new_state) -> int_field_state[] = new_state
                    )
                ),
                ...
                Container(
                    NumberField(
                        ...
                        on_focus_change=(new_state) -> float32_field_state[] = new_state
                    )
                ),
                ...
                Container(
                    NumberField(
                        ...
                        on_focus_change=(new_state) -> currency_field_state[] = new_state
                    )
                ),
                ...
                Container(
                    NumberField(
                        ...
                        on_focus_change=(new_state) -> big_int_field_state[] = new_state
                    )
                ),

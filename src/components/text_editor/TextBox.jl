...
"""
Convert mouse coordinates to cursor position within the text box.
"""
function mouse_to_cursor_position(view::TextBoxView, mouse_x::Float64, mouse_y::Float64, x::Float32, y::Float32, width::Float32, height::Float32)::CursorPosition
    font = view.style.text_style.font
    size_px = view.style.text_style.size_px
    padding = view.style.padding_px

...
function interpret_view(view::SpinnerView, x::Float32, y::Float32, width::Float32, height::Float32, projection_matrix::Mat4{Float32}, cursor_position::Point2f, window_size::Size)
    ...
    interpret_view(text_component, x, y, width, height, projection_matrix, cursor_position, window_size)
end

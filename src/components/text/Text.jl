...
function interpret_view(view::TextView, x::Float32, y::Float32, width::Float32, height::Float32, projection_matrix_points::Mat4{Float32}, cursor_position::Point2f, window_size::Size)

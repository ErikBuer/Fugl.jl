...
function interpret_view(view::PaddingView, x::Float32, y::Float32, width::Float32, height::Float32, projection_matrix::Mat4{Float32}, cursor_position::Point2f, window_size::Size)
...
function detect_click(view::PaddingView, mouse_state::InputState, x::Float32, y::Float32, width::Float32, height::Float32, parent_z::Int32)::Union{ClickResult,Nothing}
    child_x, child_y, child_width, child_height = apply_layout(view, x, y, width, height)

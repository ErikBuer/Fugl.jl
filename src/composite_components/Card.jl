...
"""
function Card(title::AbstractString="", content::AbstractView=EmptyView(); style=ContainerStyle(), title_style=TextStyle())

    cardContents = IntrinsicColumn([
            IntrinsicHeight(Text(title; style=title_style, horizontal_align=:left)),
